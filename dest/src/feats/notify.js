...
export const consoleNotify = (commandsCount, textsCount, captchaCount, totCaptchaCount, readyTimestamp) => {
    logger.log("data", "");
    ...
    logger.log("data", chalk.greenBright("Total Captcha: ") + totCaptchaCount);
...
export const selfbotNotify = (message, config, totlCaptcha, readyTimestamp, captchaError, solved = false) => new Notifier(message, config, totlCaptcha, readyTimestamp, captchaError, solved).notify();
